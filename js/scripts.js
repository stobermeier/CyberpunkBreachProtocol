...
function read_code_matrix() {
  // Read values
  var e00 = document.getElementById('e00').value
  var e10 = document.getElementById('e10').value
  var e20 = document.getElementById('e20').value
  var e30 = document.getElementById('e30').value
  var e40 = document.getElementById('e40').value
  var e50 = document.getElementById('e50').value

  var e01 = document.getElementById('e01').value
  var e11 = document.getElementById('e11').value
  var e21 = document.getElementById('e21').value
  var e31 = document.getElementById('e31').value
  var e41 = document.getElementById('e41').value
  var e51 = document.getElementById('e51').value
  ...
  var e32 = document.getElementById('e32').value
  var e42 = document.getElementById('e42').value
  var e52 = document.getElementById('e52').value

  var e03 = document.getElementById('e03').value
  var e13 = document.getElementById('e13').value
  var e23 = document.getElementById('e23').value
  var e33 = document.getElementById('e33').value
  var e43 = document.getElementById('e43').value
  var e53 = document.getElementById('e53').value
  ...
  var e34 = document.getElementById('e34').value
  var e44 = document.getElementById('e44').value
  var e54 = document.getElementById('e54').value
  ...
  var e35 = document.getElementById('e35').value
  var e45 = document.getElementById('e45').value
  var e55 = document.getElementById('e55').value
...
function find_best_sequence(ram) {
  ...
  // The script determines a lot of possible sequences. Ordered by how good they are
  var sequences = []
...
function find_combination_recursive(cm_, ram_left, seq, seq_pos, last_position, vert_horz, remaining_seqence, solutions) {
  ...
  if (vert_horz == 'vert') {
      ...
      for (var row = 0; row < 6; row++) {
          if (row != last_position[1] && cm[column][row] == rs[0]) {
              ...
              cm[column][row] = '--'
              find_combination_recursive(cm, ram_left - 1, seq + hex_val, seq_pos + column.toString() + row.toString(), [column, row], 'horz', rs.slice(1, rs.length), solutions)
          }
      }
      return
      ...
      for (var column = 0; column < 6; column++) {
          if (column != last_position[0] && cm[column][row] == rs[0]) {
              var hex_val = cm[column][row]
              cm[column][row] = '--'
              find_combination_recursive(cm, ram_left - 1, seq + hex_val, seq_pos + column.toString() + row.toString(), [column, row], 'vert', rs.slice(1, rs.length), solutions)
          }
      }
  }
}

function find_combination(code_matrix, ram, start_point, sequence, solutions) {
  ...
  if (start_point[1] == 0) {
      // Start in first row
      cm[column][row] = '--'
      find_combination_recursive(cm, ram - 1, hex_val, column.toString() + row.toString(), [column, row], 'vert', sequence.slice(1, sequence.length), solutions)
  } else {
      ...
      cm[column][0] = '--'
      cm[column][row] = '--'
      find_combination_recursive(cm, ram - 2, seq, seq_pos, [column, row], 'horz', sequence.slice(1, sequence.length), solutions)
  }
}

function solve_seq(code_matrix, seq, ram) {
  console.log("Try to solve " + seq + " with ram " + ram)
  ...
  for (var sp_index = 0; sp_index < start_points.length; sp_index++) {
      find_combination(code_matrix, ram, start_points[sp_index], seq, solutions)
  }
...
function solve() {
  ...
  var sequences = find_best_sequence(ram)

  var code_matrix_debug = [
      ['55', '1C', '55', 'BD', '1C', '7A'],
      ['7A', 'BD', '1C', '55', 'E9', '1C'],
      ['BD', '55', 'BD', '55', '55', '1C'],
      ['1C', '55', '1C', 'BD', '55', 'BD'],
